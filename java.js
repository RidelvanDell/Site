...
function atualizarEstatisticas() {
    ...
    // Atualizar tempo por matéria
    const tempoIngles = calcularTempoTotalPorAssunto('Inglês');
    const tempoProgramacao = calcularTempoTotalPorAssunto('Programação');
    const tempoPsicanalise = calcularTempoTotalPorAssunto('Psicanálise');

    document.getElementById('tempo-ingles').textContent = formatarTempoEstudo(tempoIngles);
    document.getElementById('tempo-programacao').textContent = formatarTempoEstudo(tempoProgramacao);
    document.getElementById('tempo-psicanalise').textContent = formatarTempoEstudo(tempoPsicanalise);
}
